...
import com.wishtree.rmp.dto.EmployeeCreateDto;
import com.wishtree.rmp.dto.EmployeeDto;
import com.wishtree.rmp.dto.EmployeeProfileDto;
...
import com.wishtree.rmp.repository.AllocationRepository;
                ...
                .map(employee -> {
                    ...
                    if (employee.getAllocations() != null) {
                        currentAllocation = employee.getAllocations().stream()
                                .filter(a -> a.getStatus() == com.wishtree.rmp.entity.Allocation.Status.ACTIVE)
