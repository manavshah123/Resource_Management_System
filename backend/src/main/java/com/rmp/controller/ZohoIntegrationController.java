...
import com.rmp.dto.zoho.*;
import com.rmp.entity.Project;
import com.rmp.service.ZohoProjectsService;
...
public class ZohoIntegrationController {
    ...
    public ResponseEntity<Map<String, String>> getAuthUrl() {
        ...
        String authUrl = zohoProjectsService.getIntegrationStatus() != null 
                && zohoProjectsService.getIntegrationStatus().getStatus() == com.rmp.entity.ZohoIntegration.Status.CONNECTED
                ? null 
                : String.format(
